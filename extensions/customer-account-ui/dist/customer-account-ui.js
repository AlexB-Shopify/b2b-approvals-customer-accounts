...
${errorInfo.componentStack}`);
  ...
  // extensions/customer-account-ui/src/OrderBlockExtension.tsx
  var import_jsx_runtime4 = __toESM(require_jsx_runtime());
  var OrderBlockExtension_default = reactExtension(
    "customer-account.order-index.block.render",
    () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockExtension, {})
  );
  function BlockExtension() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Card2, { padding: true, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(InlineStack2, { inlineAlignment: "center", spacing: "tight", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: "Your team have submitted PO Requests." }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Link2, { to: "extension:customer-account-ui/", children: "View approval queue" })
    ] }) });
  }

  // extensions/customer-account-ui/src/FullPageExtension.tsx
  var import_react21 = __toESM(require_react());
  var import_jsx_runtime5 = __toESM(require_jsx_runtime());
  var FullPageExtension_default = reactExtension(
    "customer-account.page.render",
    () => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(FullPageExtension, {})
  );
  function FullPageExtension() {
    const { i18n, query } = useApi();
    const [approvals, setApprovals] = (0, import_react21.useState)([]);
    const [loading, setLoading] = (0, import_react21.useState)(false);
    const [removeLoading, setRemoveLoading] = (0, import_react21.useState)({ id: null, loading: false });
    ...
    function deleteApprovalsItem(id) {
      return __async(this, null, function* () {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Page2, { title: "Approval Queue", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Grid2, { columns: ["fill", "fill", "fill"], rows: "auto", spacing: "loose", children: [
      ...
      !loading && approvals.length > 0 && approvals.map((approval) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(ResourceItem2, { loading, action: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(BlockStack2, { spacing: "base", children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TextBlock2, { children: approval.node.identifier.value }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TextBlock2, { children: approval.node.approval_status.value })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(BlockStack2, { spacing: "base", children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(TextBlock2, { children: [
              orderDetails.line_items.length,
              " items"
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TextBlock2, { children: orderDetails.name })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(BlockStack2, { spacing: "base", children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TextBlock2, { children: orderDetails.customer.first_name + " " + orderDetails.customer.last_name }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TextBlock2, { children: orderDetails.shipping_address.address1 })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(BlockStack2, { spacing: "base", children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(TextBlock2, { children: [
              "$",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TextBlock2, { children: orderDetails.payment_terms ? orderDetails.payment_terms : "Payment Due" })
          ] })
        ] }, approval.node.id);
      }),
      !loading && approvals.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TextBlock2, { children: "No orders in your approvals queue." })
    ] }) });
  }
})();
